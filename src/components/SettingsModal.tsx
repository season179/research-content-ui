                        ...
                        <div className="flex items-start gap-3">
                            ...
                            <div className="text-sm text-gray-600">
                                ...
                                <p>
                                    ...
                                    browser's storage and never transmitted to
                                    our servers. The author has no access to
                                    your keys.
                                </p>
                            </div>
                        </div>
                            ...
                            {!showDeleteConfirm ? (
                                ...
                                <div className="border rounded-lg p-4 bg-red-50">
                                    <p className="text-sm text-red-700 mb-3">
                                        Are you sure you want to delete your API
                                        keys? You'll need to enter them again to
                                        use the app.
                                    </p>
